...
public class AsyncConfig implements AsyncConfigurer {
    ...
    public Executor asyncTaskExecutor() {
        ...
        executor.setMaxPoolSize(7); // 동시 동작하는, 최대 Thread 갯수
        executor.setQueueCapacity(2); // MaxPoolSize를 초과하는 요청이 Thread 생성 요청시 해당 내용을 Queue에 저장하게 되고, 사용할수 있는 Thread 여유 자리가 발생하면 하나씩 꺼내져서 동작하게 된다.
